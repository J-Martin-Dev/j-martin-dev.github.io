      ...
      },
      {
      ...
      },
       {
        ...
        description: [
          ...
          "Desarrollo de aplicaciones de automatización.",          
          "Desarrollo y mantenimiento de aplicaciones para disposivos embebidos (Windows CE).",
          "Servicio de asistencia post-venta.",
        ],
      },
      {
    ...
    proyects: [         
      {
        ...
        description: [
          ...
          "- #TIA Portal V19, #SQL, #Sinamics S120, #PROFINET.",        
        ],
      },    
      {
        name: "SISAMEX - México",
        ...
        description: [
          "Máquina de temple de componentes para automoción.",     
          "- #TIA Portal V19, #SQL, #Sinamics S120, #PROFINET, #Safety integrated.",             
        ],
      },      
      {
        name: "RollRite - EEUU",
        ...
        description: [
          ...
          "- #TIA Portal V18, #Sinamics V90, #PROFINET",
        ],
      },
      {
        name: "FANASA - Mexico",
        ...
        description: [
          "Máquina de temple de componentes para automoción.",    
          "- #Studio 5000, #FactoryTalk, #Kinetix 5500, #Ethernet/IP",   
        ],
      },
      {
        name: "I+D",
      ...
      },      
      {
        ...
        description: [
          ...
          "- #TIA Portal V18, #Sinamics V90, #PROFINET, ISA S88.",      
        ],
      },      
      {
        name: "IFA - Alemania",
      ...
      },
      {
        ...
        description: [
          "Máquina de temple y revenido de componentes para automoción.",   
          "- #TIA Portal V17, #Sinamics V90, #PROFINET.",       
        ],
      },
      {
        name: "Valourec - Francia",
        company: "GH Induction",
        period: "2021.8 - 2021.12",
        description: [
      ...
      }, 
      {
        ...
        description: [
          "Máquina de temple y revenido de componentes para automoción.",  
          "- #TIA Portal V17, #Sinamics V90, #CU-320, #PROFINET.",        
        ],
      },
      {
        ...
        description: [
          ...
          "- #TIA Portal V15.1, #WinCC, #RSLogix 5, #PROFINET, #Safety integrated.",        
        ],
      },
      {
        ...
        description: [
          ...
          "- #TIA Portal V13, V14, V15.1, #WinCC, #RSLogix 5, #RSLogix 500, #RSLogix 5000, #PROFINET, #Ethernet/IP, #Safety integrated, #C#, #Cognex 5000/7000, #Yamaha RCX480.",
        ],
      },
      {
      ...
      },
      {
        ...
        description: [
          "Desarrollo y puesta en marcha de grandes cargas.", 
          "- #Step 7, #WinCC flexible, #Siemens S7-300, #Siemens S7-400, #Sinamics G120, #PROFINET.",        
        ],
      },
      {
      ...
      },
      {
        ...
        description: [
          ...
          "- #Step 7, #WinCC flexible, #Siemens S7-300, #Sinamics G120, #PROFINET.",             
        ],
      },      
      {
        ...
        description: [
          ...
          "- #Soft-plc propietario, #RSLogix 500, #Visual Basic.",                 
        ],
      },       
      {
